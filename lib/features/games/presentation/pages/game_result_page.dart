...
class _GameResultPageState extends State<GameResultPage> {
  ...
  void initState() {
    super.initState();
    final pct = widget.result.score / widget.result.total;
    if (pct >= 0.5) {
      _confettiCtrl.play();
      SoundHelper.playSound('win.mp3');
    } else {
      SoundHelper.playSound('loss.mp3');
    }
  }
  ...
  String get _gameLabel {
    return switch (widget.result.gameKey) {
          ...
          SafeArea(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(_grade, style: TextStyle(fontSize: 44.sp)),
